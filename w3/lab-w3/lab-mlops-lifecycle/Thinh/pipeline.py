...
def load_features(csv_path: str) -> pd.DataFrame:
    """Load CSV and extract feature columns, dropping NaN rows."""
...
def train(
    ...
    """Train IsolationForest, log everything to MLflow, register model."""
    ...
    # Compute anomaly rate: -1 = anomaly, 1 = normal
    ...
    with mlflow.start_run() as run:
        ...
        # Log scaler as artifact (needed for serving to ensure consistent scaling)
